...
subs49088 =[((0, 4), ' ', 'bottom', 'white'),
((4, 7), 'Intro Title', 'center', 'white'),
((7, backgroundintroClip.duration), ' ', 'bottom', 'white')]
introClip = [annotate(backgroundintroClip.subclip(from_t, to_t), txt, position, color) for (from_t, to_t), txt, position, color in subs49088]
clip1 = VideoFileClip("resources/video/alderamin 1.webm")
clip1a = clip1.subclip(23,107)
subs66511 =[((0, 10), 'subclip 1a subtitle', 'bottom', 'white'),
((40, 50), 'subclip 1a subtitle 2', 'bottom', 'white'),
((50, clip1a.duration), ' ', 'bottom', 'white')]
clip1a_with_subtitle = [annotate(clip1a.subclip(from_t, to_t), txt, position, color) for (from_t, to_t), txt, position, color in subs66511]
clip1b = clip1.subclip(121,141)
backgroundoutroClip= ColorClip(size=(1920,1080), color=(0, 0, 0)).set_duration(10)
subs80065 =[((0, 10), 'THANKS FOR WATCHING', 'center', 'white'),
((10, backgroundoutroClip.duration), ' ', 'bottom', 'white')]
outroClip = [annotate(backgroundoutroClip.subclip(from_t, to_t), txt, position, color) for (from_t, to_t), txt, position, color in subs80065]
